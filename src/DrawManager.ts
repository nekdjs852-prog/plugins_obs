...
// штрих = набор точек, сглаживаю кривыми. готовые штрихи — отдельные <svg> (чтоб
// масштабировались с холстом и были в слоях), текущий рисую превью на временном canvas
