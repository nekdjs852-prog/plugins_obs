// ТИПЫ ДАННЫХ ДОСКИ (только описания структур, без логики).
// Здесь описано, как выглядят: фигура (BoardNode), соединитель (Connector),
// штрих рисования (Stroke), объект панели слоёв (LayerObject), настройки и т.д.
// Это «чертежи» данных — TypeScript по ним проверяет код на ошибки.
