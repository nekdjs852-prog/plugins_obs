// вся математика таймлайна, без react (так проще тестить).
// buildTimeline считает пиксели-на-день под зум, позицию+ширину событий,
// раскладку по дорожкам (чтоб не накладывались), засечки оси и где «сегодня»
...
// раскладка по дорожкам, как парковка: кладу событие на первую свободную дорожку
// (где предыдущее уже закончилось). свободной нет — завожу новую. так не накладываются
