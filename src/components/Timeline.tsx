// главный компонент. держит состояние: режим (таймлайн/календарь), зум, теги, папку.
// фильтрует события, считает геометрию через buildTimeline и рисует ось/события/«сегодня»
